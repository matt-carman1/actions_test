...
def test_delete_lrs_created_by_non_admin(ld_api_client, new_live_report, lr_type, username, password,
                                         is_deletion_allowed):
    """
    Test to check if LR created by Non-admin user could be deleted by users with different roles
