...
def get_parser():
    ...
    desc = 'Set the value to whatever is passed in the commandline'

    # create the top-level parser
    parser = argparse.ArgumentParser(description=desc)
    parser.add_argument('-result', dest='result', action='store', default='', type=str, help='Manual result')
...
def print_csv(args):
    ...
    for structure in SDReader(filename):
        ...
        print(ROW.format(corp_id=corp_id, result=result))
